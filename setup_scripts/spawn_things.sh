...
ros2 run gazebo_ros spawn_entity.py -entity cross4 -file cross/model.sdf -x 0.245 -y 0.020 -z 0.02

ros2 run gazebo_ros spawn_entity.py -entity circle7 -file circle/model.sdf -x 0.245 -y -0.025 -z 0.02

ros2 run gazebo_ros spawn_entity.py -entity cross9 -file cross/model.sdf -x 0.155 -y -0.025 -z 0.02